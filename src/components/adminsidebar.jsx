                                ...
                                >
                                    {item.subItems ? (
                                        ...
                                        >
                                            <item.icon
                                                size={20}
                                                className={`transition-colors duration-200 shrink-0 ${isActive ? 'text-blue-400' : 'text-gray-400 group-hover:text-white'}`}
                                            />
                                        ...
                                        >
                                            <item.icon
                                                size={20}
                                                className={`transition-colors duration-200 shrink-0 ${isActive ? 'text-white' : 'text-gray-400 group-hover:text-white'}`}
                                            />
