...
const INITIAL_MESSAGES = {
  ...
  'c2': [
    { id: 1, sender: 'admin', message: 'Your repair is complete and ready for pickup.', timestamp: new Date(Date.now() - 86400000).toISOString(), type: 'text', status: 'read' },
...
const AdminDualPaneDashboard = ({ onClose, isFullScreen, toggleFullScreen }) => {
...
export default function AdminChatWidget() {
  ...
  return (
    <>
      {!isOpen && <AdminChatLauncher onClick={() => setIsOpen(true)} unreadCount={totalUnread} />}
