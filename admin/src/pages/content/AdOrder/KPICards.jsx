                ...
                {cards.map((card, index) => (
                    ...
                    >
                        ...
                        <div className="flex items-center gap-2 mb-1.5 sm:mb-3">
                            ...
                            <span className={`text-[9px] sm:text-[12px] font-bold sm:font-semibold text-gray-500 truncate leading-tight ${index === 4 ? 'max-w-none' : 'max-w-[45px] sm:max-w-none'}`}>{card.label}</span>
                        </div>
                        ...
                        <div className="hidden sm:block text-[10px] text-gray-400 mt-0.5 pl-[45px]">{card.sub}</div>
                    </div>
                ))}
            </div>
        </div>
