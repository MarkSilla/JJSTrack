...
import { UserPlus, Edit2, Trash2, Check, X, Building2, Ruler, Maximize2, Minimize2 } from 'lucide-react'
            ...
            <aside className="bg-white border border-blue-100 rounded-2xl p-4 shadow-lg shadow-blue-100/60 lg:sticky lg:top-4 lg:self-start">
                <div className="flex items-start justify-between gap-3 mb-3">
                    <div>
                        ...
                        <p className="text-xs text-gray-500 mt-1">Use this chart before selecting member sizes.</p>
                    </div>
                ...
                <figure>
                    ...
                    <img src={image.mtshirt} alt="Men Tshirt Size" className="w-full max-h-[32rem] object-contain rounded-xl border border-gray-100 bg-gray-50" />
                </figure>
                <figure>
                    <figcaption className="text-[10px] font-semibold uppercase tracking-wider text-gray-400 mb-2">Women's T-shirt / Polo</figcaption>
                    <img src={image.wtshirt} alt="Women Tshirt Size" className="w-full max-h-[32rem] object-contain rounded-xl border border-gray-100 bg-gray-50" />
                </figure>
            </aside>
                ...
                <div className="fixed inset-0 z-[80] bg-black/80 backdrop-blur-sm p-3 sm:p-6 flex items-center justify-center">
                    <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-5xl max-h-[94vh] overflow-y-auto p-4 sm:p-6">
                        ...
                        <figure>
                            ...
                            <img src={image.mtshirt} alt="Top size chart" className="w-full max-h-[80vh] object-contain rounded-xl border border-gray-200 bg-gray-50" />
                        </figure>
                        <figure>
                            <figcaption className="text-xs font-bold uppercase tracking-wider text-blue-600/70 mb-2">Women's T-shirt / Polo</figcaption>
                            <img src={image.wtshirt} alt="Top size chart" className="w-full max-h-[80vh] object-contain rounded-xl border border-gray-200 bg-gray-50" />
                        </figure>
                    </div>
                </div>
            )}
    ...
    return (
        <section>
            ...
            <div className={`${showSizeGuide ? 'max-w-6xl' : 'max-w-xl'} mx-auto mb-6`}>
                ...
                <div className={`grid gap-5 ${showSizeGuide ? 'lg:grid-cols-[minmax(0,46rem)_minmax(24rem,28rem)]' : 'grid-cols-1'}`}>
                            ...
                            <div className="flex items-center justify-between gap-3">
                                ...
                                <div className="flex items-center gap-2 ml-auto">
                                    <button
                                        ...
                                        className="inline-flex items-center gap-1.5 text-xs font-semibold text-blue-600 hover:text-blue-700 transition-colors cursor-pointer mr-2"
                                    >
                                        <Ruler size={15} />
                                        {showSizeGuide ? 'Hide' : 'View Sizes'}
                                    </button>
                                    <div className="h-4 w-px bg-gray-200 mx-1 mr-2" />
                                    <button
                                        type="button"
                                            ...
                                            <div className="flex items-center gap-4 min-w-0">
                                                ...
                                                <div className="min-w-0">
                                                    ...
                                                    <p className="text-gray-400 text-xs mt-0.5">
                                                        {product?.label || '—'} · {m.useManualSize ? `${m.manualBody}"×${m.manualLength}"×${m.manualSleeveLength}"` : `Size: ${m.size || '—'}`}
                                                    </p>
                                                </div>
                                            </div>
