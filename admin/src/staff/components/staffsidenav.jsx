...
const StaffSidebar = ({ collapsed, setCollapsed, isMobileExpanded, setIsMobileExpanded }) => {
    ...
    return (
        <>
            ...
            <aside
                id="jjs-sidebar"
                className={`fixed top-0 left-0 h-screen bg-[#0F172A] text-white transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] z-40 shadow-xl border-r border-gray-700 flex flex-col font-inter
          ${isSmallScreen
                ...
                <div className="p-4 pl-[24px] border-b border-gray-700 flex items-center justify-between">
                    <div className="flex items-center w-full">
                        ...
                        >
                            ...
                            <p className="text-gray-400 text-xs uppercase font-semibold tracking-widest mt-0.5 leading-none">Staff Portal</p>
                        </div>
                    </div>
                </div>
                    ...
                    <ul className="space-y-1.5 px-3">
                        {navItems.map((item, index) => {
                            if (item.type === 'section') {
                                return (
                                    <li key={item.label} className="relative py-0.5 transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1)]">
                                        <div
                                            className="transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] overflow-hidden whitespace-nowrap"
                                            style={{
                                        ...
                                        <div
                                            className="transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] border-t border-gray-700/60"
                                            style={{
                                                maxHeight: showLabel ? '0px' : '1px',
                                                opacity: showLabel ? 0 : 1,
                                                margin: showLabel ? '0px' : '8px 12px',
                                                pointerEvents: 'none'
                                            }}
                                        />
                                    </li>
                                ...
                                >
                                    {item.subItems ? (
                                        <button
                                            ...
                                            className={`flex items-center w-full py-2.5 rounded-xl transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] group border-none cursor-pointer outline-none bg-transparent text-left
                                        ...
                                        >
                                            ...
                                            >
                                                <div className="flex flex-col">
                                                    ...
                                                    {item.description && (
                                                        <span className={`text-[11px] leading-tight mt-0.5 ${isActive ? 'text-blue-300/80' : 'text-slate-500'}`}>
                                                            {item.description}
                                                        </span>
                                                    )}
                                                </div>
                                        ...
                                        <Link
                                            ...
                                            className={`flex items-center w-full py-2.5 rounded-xl transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] group outline-none
            ...
            {!isSmallScreen && (
                <button
                    ...
                    className="fixed w-6 h-6 bg-[#0F172A] border border-gray-700 rounded-full flex items-center justify-center hover:bg-gray-800 hover:border-blue-500 transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] shadow-xl z-50 group cursor-pointer"
