...
const NAV_ITEMS = [
    ...
    { icon: ScanQrCode, label: 'QR Scanner', path: '/staff/qr-scanner' },
]
...
const StaffSidebar = ({
    ...
    const mobileOpen = isMobileOpen ?? isMobileExpanded ?? false
    const setMobileOpen = setIsMobileOpen ?? setIsMobileExpanded ?? (() => { })
        ...
        <>
            ...
            <aside
                ...
                className={`fixed top-0 left-0 h-screen bg-[#0F172A] text-white z-50 shadow-2xl border-r border-slate-800 flex flex-col font-inter transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1)]
                    w-72 max-w-[85vw]
                    ${mobileOpen ? 'translate-x-0 pointer-events-auto' : '-translate-x-full pointer-events-none max-lg:invisible'}
                ...
                <div className="p-3.5 border-b border-slate-800 flex items-center justify-between shrink-0 h-16">
                    <div className="flex items-center min-w-0">
                        ...
                        <div className={`flex flex-col ml-3 overflow-hidden whitespace-nowrap transition-opacity duration-200 ${
                            ...
                            <p className="text-slate-400 text-[10px] uppercase font-semibold tracking-widest mt-1 leading-none">Staff Portal</p>
                        </div>
                    </div>
