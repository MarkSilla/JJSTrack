...
function Login() {
    ...
    const handleAuthComplete = () => {
        if (pendingAuthData) {
            localStorage.setItem('staffToken', pendingAuthData.token)
            localStorage.setItem('rememberStaffEmail', pendingAuthData.email)
            persistStoredStaffUser(pendingAuthData.staff)
