...
import { MdClose, MdCalendarToday, MdAccessTime, MdInfo } from 'react-icons/md'
        ...
        <div className="flex min-h-screen bg-[#F8FAFC]">
            ...
            <div className={`flex-1 transition-all duration-300 ${collapsed ? 'ml-0 sm:ml-[70px]' : 'ml-0 sm:ml-[240px]'}`}>
                ...
                <main className="p-6 lg:p-8">
                    {/* Header */}
                    <div className="mb-8">
                        <h1 className="text-2xl font-extrabold text-[#0f172a] tracking-tight">Appointments</h1>
                        <p className="text-sm text-gray-400 mt-1 font-medium">View availability and manage your bookings</p>
                    </div>
                                    ...
                                    <div className="text-center py-3">
                                        ...
                                        <div className="mt-3 mx-auto max-w-[200px]">
                                            <div className="h-2.5 rounded-full bg-gray-100 overflow-hidden">
                                                <div
                                                    className={`h-full rounded-full transition-all duration-500 ${selUsed / MAX_SLOTS >= 0.8
