...
export const AuthLoadingScreen = ({ onComplete }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100000] flex flex-col items-center justify-center font-inter animate-fade-in overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-lg px-8 flex flex-col items-center text-center">
        <h2 className="flex flex-col items-center text-2xl font-black text-white tracking-widest mb-1 italic">
          <img src={jjsLogo} alt="JJS logo" className="w-24 h-24 object-contain mb-2" />
          <span>
