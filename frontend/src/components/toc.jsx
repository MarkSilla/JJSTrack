                    ...
                    return (
                        <li key={s.id}>
                            <div
                                ...
                                className={`text-left w-full text-sm py-2 px-3 rounded-md transition-all duration-150 cursor-pointer flex items-center gap-3 ${
                                    active === s.id
                            ...
                            >
                                {num && (
                                    <span className={`font-bold shrink-0 ${
                                        active === s.id ? "text-blue-700" : "text-stone-400"
                                    }`}>
                                        {num}.
                                    </span>
                                )}
